...
class CategoryDiseaseList extends StatefulWidget {
  const CategoryDiseaseList({super.key});

  @override
  State<CategoryDiseaseList> createState() => _CategoryDiseaseListState();
}

class _CategoryDiseaseListState extends State<CategoryDiseaseList> {
  ...
  Widget build(BuildContext context) {
    ...
    var gapHeight1 = 20.0;
    return Scaffold(
      appBar: CustomAppBar3(title: diseaseType), // Display disease type in the title
      body: Column(
        children: [
          ...
          // Search Bar (Optional)
          GFSearchBar(
            searchList: const ["Flutter", "React", "Ionic", "Xamarin"],
          ...
          StreamBuilder<List<DiseaseModel>>(
            stream: diseaseService.streamDiseasesByType(diseaseType),
...
class CategoryDiseaseCard extends StatelessWidget {
  final DiseaseModel? disease;

  const CategoryDiseaseCard({
    Key? key,
